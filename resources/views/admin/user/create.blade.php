          ...
          <div class="form-group col-md-12">
            ...
            <div class="col-sm-8">
              <div class="input-group">
                ...
                <input type="text" id="name" name="name" class="form-control name" placeholder="输入 用户名" value="{!!old('name')!!}">
              </div>
            </div>
          </div>
          <div class="form-group col-md-12">
            ...
            <div class="col-sm-8">
              <div class="input-group">
                ...
                <input type="text" id="email" name="email" class="form-control email" placeholder="输入 邮箱" value="{!!old('email')!!}">
              </div>
            </div>
          </div>
          <div class="form-group col-md-12">

          ...
          <div class="form-group col-md-12">
            ...
            <div class="col-sm-8">
              <div class="input-group">
                ...
                <input type="text" id="name" name="name" value="{!!$user->name!!}" class="form-control name" placeholder="{!!trans('labels.user.name')!!}" disabled>
              </div>
            </div>
          </div>
          <div class="form-group col-md-12">
            ...
            <div class="col-sm-8">
              <div class="input-group">
                ...
                <input type="text" id="email" name="email" value="{!!$user->email!!}" class="form-control email" placeholder="{!!trans('labels.user.email')!!}">
              </div>
            </div>
          </div>
          <div class="form-group col-md-12">

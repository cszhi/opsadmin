        ...
        <div class="box-body">
          <div class="form-group col-md-12">
            ...
            <div class="col-sm-8">
              <div class="input-group">
                ...
                <input type="text" id="name" name="name" value="{!!$role->name!!}" class="form-control name" placeholder="输入 角色名称">
              </div>
            </div>
          </div>
          <div class="form-group col-md-12">
            ...
            <div class="col-sm-8">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                <input type="text" id="slug" name="slug" value="{!!$role->slug!!}" class="form-control slug" placeholder="输入 角色">
              </div>
            </div>
          </div>
          {{--select2
          ...
          <div class="form-group col-md-12">
            ...
            <div class="col-sm-8">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                <input type="text" id="description" name="description" value="{!!$role->description!!}" class="form-control description" placeholder="输入 描述">
              </div>
            </div>
          </div>
